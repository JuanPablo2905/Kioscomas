...
function App() {
  ...
  return <main>
    ...
    <section className="hero" id="inicio"><div className="hero-copy hero-enter"><div className="eyebrow"><Sparkles size={15}/> Hecha para comercios reales</div><h1>Tu negocio, <i>más claro</i> todos los días.</h1><p>Stock, ventas, caja, compras y clientes en una sola herramienta simple de usar. Pensada para kioscos y comercios de barrio.</p><div className="hero-actions" style={{flexWrap:"wrap"}}><a className="button primary" href={cloudAppUrl}>Ingresar a mi cuenta <ArrowRight size={18}/></a><a className="button ghost" href={demoUrl}>Probar demo <ArrowRight size={18}/></a><a className="button ghost" href={windowsDownloadUrl}><Download size={18}/> Windows</a><a className="button ghost" href={macDownloadUrl}><Download size={18}/> Mac</a></div><div className="hero-trust"><span><Check size={15}/> Windows 10 y 11</span><span><Check size={15}/> Mac Intel y Apple Silicon</span><span><Check size={15}/> Celular y computadora</span><span><Check size={15}/> Hecha en Argentina</span></div></div><div className="hero-visual hero-device-enter"><div className="glow"/><DemoPanel/><div className="demo-hint"><span><Sparkles size={14}/> Tocá las secciones para recorrer la app</span><a href={demoUrl}>Abrir la demo completa <ArrowRight size={15}/></a></div></div></section>
