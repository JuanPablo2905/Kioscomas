...
import { Cloud, ImagePlus, LayoutPanelLeft, Palette, Printer, Settings, ShieldCheck, SlidersHorizontal, Store, Trash2, X } from "lucide-react";
...
export function SettingsModal({ preferences, onChange, onClose, cuenta, tenantId, onUpdateAccount, canEditBusiness = true }) {
