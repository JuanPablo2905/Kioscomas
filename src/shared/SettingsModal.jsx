...
export function SettingsModal({ preferences, onChange, customerDisplayPreferences = {}, onCustomerDisplayChange, onClose, cuenta, tenantId, onUpdateAccount, canEditBusiness = true, onCleanOperationalHistory, onExportCommercialArchive, archiveStats, syncStatus, initialSection = "apariencia", notificationPreviewMode = false, onReportProblem }) {
