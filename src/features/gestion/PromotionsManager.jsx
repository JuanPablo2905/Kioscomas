  ...
  return <div className="grid min-w-0 gap-5 xl:grid-cols-[420px_1fr]">
    <div className="min-w-0 rounded-xl border bg-white p-4 sm:p-5">
      ...
      <div className="mt-4 grid gap-3">
        ...
        <div className="grid grid-cols-1 gap-2 min-[360px]:grid-cols-2"><div className="min-w-0 text-xs opacity-70">Desde (opcional)<KioscoDatePicker value={form.desde} onChange={(fecha) => set("desde", fecha)} className="mt-1"/></div><div className="min-w-0 text-xs opacity-70">Hasta (opcional)<KioscoDatePicker value={form.hasta} onChange={(fecha) => set("hasta", fecha)} min={form.desde} className="mt-1"/></div></div>
