...
test("provincia y ciudad usan el catálogo oficial con provincia primero, y hay respaldo si no carga", settings.includes("fetchArgentinaProvincias") && settings.includes("fetchArgentinaLocalidades") && settings.indexOf("provinciaId") < settings.indexOf("localidadId") && settings.includes('provinciasStatus === "error"') && settings.includes('localidadesStatus === "error"'));
