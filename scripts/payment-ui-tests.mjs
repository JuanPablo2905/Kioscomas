...
test("la caja recupera del servidor el QR y el Point configurados", sales.includes("paymentProvider?.qr?.posExternalId") && sales.includes("paymentProvider?.point?.terminalId"));
