...
try {
  ...
  await request("/v1/activation/admin", { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ deviceId: "boundary-device", deviceKey: administratorSecret, appVersion: "0.2.26" }) });
